...
try:
    # 1. Get the absolute path to the folder containing THIS script (soloud.py)
    _engine_dir = os.path.dirname(os.path.abspath(__file__))

    # 2. Glue the folder path to the EXACT DLL name
    _libpath = os.path.join(_engine_dir, "soloud_x64.dll")

    # 3. Load it using the Full GPS Coordinate
    import ctypes
    soloud_dll = ctypes.CDLL(_libpath)

except Exception as e:
    print(f"Error loading SoLoud: {e}")
...
class Monotone(object):
	...
	def set_params(self, aHardwareChannels, aWaveform=0):
